...
import img_basurero from '../../assets/recycle_plastic.png'
            ...
            <div className="content-wrap">
                ...
                <Container maxWidth="false" sx={{display:'flex', justifycontent:'center', width: "95%"}}>
                    <Grid container alignItems="center" rowSpacing={1} columnSpacing={{ xs: 1, sm: 2, md: 3 }}>
                        ...
                        <Grid item xs={9}>
                            <Paper elevation={2} sx={{padding:"10px", margin:"5px", backgroundColor: "rgba(229, 224, 91, 0.5)", color:"primary.contrastText"}}>
